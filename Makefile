...
debug:
	...
	# RUST_LOG=info cargo test --features "tree_latch, aries_no_steal, aries_no_force, read_committed" -- --test-threads=1 --exact integretions::tx_isolation_test::test_anomaly_dirty_read 2>&1 | tee out
