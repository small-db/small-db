...
// thread 'main' panicked at 'rwlock write lock would result in deadlock',
// /rustc/a55dd71d5fb0ec5a6a3a9e8c27b2127ba491ce52/library/std/src/sys/unix/
// locks/pthread_rwlock.rs:111:13 impl Drop for Transaction {
//     fn drop(&mut self) {
//         self.commit().unwrap();
//     }
// }
